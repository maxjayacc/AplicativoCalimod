...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CMSoftInventario.App.Adapter.TabsFragmentPagerAdapter, CMSoftInventario", TabsFragmentPagerAdapter.class, __md_methods);
	}
	...
	public TabsFragmentPagerAdapter (android.support.v4.app.FragmentManager p0)
	{
		...
		if (getClass () == TabsFragmentPagerAdapter.class)
			mono.android.TypeManager.Activate ("CMSoftInventario.App.Adapter.TabsFragmentPagerAdapter, CMSoftInventario", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0 });
	}
